...
//        String url = ERROR_PAGE;
        ...
        try {
            ...
            // 2. Refresh --> call the Search Function again using URL rewriting tech
            if(result) {
...
//                        + "&txtSearchValue=" + searchValue;
            ...
            log("DeleteAccountServlet _SQL: " + ex.getMessage());
        } catch (NamingException ex) {
            log("DeleteAccountServlet _Naming: " + ex.getMessage());
        }
        finally {
